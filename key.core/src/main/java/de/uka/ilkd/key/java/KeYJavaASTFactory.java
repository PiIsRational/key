...
public abstract class KeYJavaASTFactory {
    ...
    /**
     * create a local variable declaration <br>
     * </br>
     ...
     */
    public static Statement ifElse(final Expression guard, final Statement thenStatement,
     ...
     */
    public static BinaryOperator equalsNullOperator(final Expression expression) {
    ...
    public static IGuard lessThanGuard(final Expression left, final Expression right) {
        return new Guard(lessThanOperator(left, right));
    }
     ...
     */
    public static BinaryOperator lessThanZeroOperator(final Expression expression) {
        final IntLiteral zeroLiteral = zeroLiteral();
     ...
     */
    public static FieldReference fieldReference(final Services services, final String name,
